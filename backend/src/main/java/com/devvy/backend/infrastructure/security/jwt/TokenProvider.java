package com.devvy.backend.infrastructure.security.jwt;
...
import com.devvy.backend.infrastructure.config.ApplicationProperties;
import com.devvy.backend.infrastructure.security.SecurityMetersService;
...
public class TokenProvider {
    ...
    public Authentication getAuthentication(String token) {
        ...
        Collection<? extends GrantedAuthority> authorities = Arrays
            ...
            .map(role -> new SimpleGrantedAuthority(AuthorityType.valueOf(role).getRole()))
